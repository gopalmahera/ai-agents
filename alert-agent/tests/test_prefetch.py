...
class TestBuildPrefetch(unittest.TestCase):
    @patch("services.metrics.prefetch.prefetch_workload_context", return_value=None)
    @patch("services.metrics.prefetch.prefetch_kafka_context", return_value=None)
    @patch("services.metrics.prefetch.prefetch_kafka_metrics", return_value=None)
    @patch("services.metrics.prefetch.prefetch_pod_metrics", return_value=None)
    @patch("services.metrics.prefetch.prefetch_host_metrics", return_value=None)
    ...
    @patch("services.metrics.prefetch.prefetch_kafka_metrics", return_value=None)
    @patch(
        "services.metrics.prefetch.prefetch_pod_metrics",
        return_value={
    ...
    @patch("services.metrics.prefetch.prefetch_workload_context", return_value={"alert_meaning": "Consumer lag high", "bullets": ["lag: 5000"]})
    @patch("services.metrics.prefetch.prefetch_kafka_context", return_value=None)
    @patch("services.metrics.prefetch.prefetch_kafka_metrics", return_value=None)
    @patch("services.metrics.prefetch.prefetch_pod_metrics", return_value=None)
    @patch("services.metrics.prefetch.prefetch_host_metrics", return_value=None)
