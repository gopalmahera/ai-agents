...
from services.metrics.host_metrics import (
...
class TestResolveScrapeInstance(unittest.TestCase):
    @patch("services.metrics.host_metrics._has_up_metric")
    ...
    @patch("services.metrics.host_metrics._discover_instance_by_host_ip")
    @patch("services.metrics.host_metrics._has_up_metric", return_value=False)
...
class TestPrefetchHostMetrics(unittest.TestCase):
    @patch("services.metrics.host_metrics._fetch_ec2_host_snapshot")
    @patch("services.metrics.host_metrics.resolve_scrape_instance")
