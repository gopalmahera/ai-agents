...
let LogsController = class LogsController {
    list(q, type, limit) {
        return (0, logs_1.listLogs)(q || '', type || '', limit ? parseInt(limit, 10) : 100);
    }
    get(filename) {
        try {
            return { filename, content: (0, logs_1.readLog)(filename) };
        }
        catch (e) {
            throw new common_1.NotFoundException({ error: String(e) });
        }
    }
    remove(filename) {
        try {
            (0, logs_1.deleteLog)(filename);
            return { ok: true };
        }
        catch (e) {
            throw new common_1.NotFoundException({ error: String(e) });
