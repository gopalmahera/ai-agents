...
sys.modules.pop("controllers.investigation_controller", None)
import importlib
import controllers.investigation_controller as _agent_module
...
class TestInvestigateAlert(unittest.TestCase):
    def setUp(self):
        # Ensure sys.modules["controllers.investigation_controller"] always points to the real module during tests.
        sys.modules["controllers.investigation_controller"] = _agent_module
